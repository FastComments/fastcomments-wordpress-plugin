<div id="fastcomments-admin">
    ...
    <div class="tiles">
        <a href="<? echo FastCommentsPublic::getSite() ?>/auth/my-account/" target="_blank">
        ...
        <a href="<? echo FastCommentsPublic::getSite() ?>/auth/my-account/moderate-comments" target="_blank">
        ...
        <a href="<? echo FastCommentsPublic::getSite() ?>/auth/my-account/customize-widget" target="_blank">
        ...
        <a href="<? echo FastCommentsPublic::getSite() ?>/auth/my-account/manage-data/export" target="_blank">
        ...
        <a href="<? echo FastCommentsPublic::getSite() ?>/auth/my-account/integrations/v1/setup?token=<?php echo get_option("fastcomments_token") ?>&hasAccount=true" target="_blank">
